import torch
import numpy as np
from log_ratio.log_ratio_with_limit_in_error import Log_Ratio_LE
...
class MAQL_LE():
    ...
    def __init__(self, env, q_nn_param, nu_param, algo_param, max_episodes =100, memory_capacity =10000,
        ...
        self.log_ratio = Log_Ratio_LE(self.nu_param, self.algo_param, deterministic_env=deterministic_env, averege_next_nu=average_next_nu,
