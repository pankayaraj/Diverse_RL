...
class DivQL():
    ...
    def __init__(self, env, q_nn_param, nu_param, algo_param, num_z, optim_alpha=0.8, max_episode_length=100,
        ...
        self.log_ratio = Log_Ratio(self.nu_param, self.algo_param, deterministic_env=deterministic_env,
                                   num_z=self.num_z, averege_next_nu=average_next_nu,
    ...
    def step(self, R_max):
        ...
        for i in range(self.max_episode_length):
            ...
            action, self.steps_done, self.epsilon = epsilon_greedy(q_values, self.steps_done, self.epsilon,
                                                                   self.action_dim)
    ...
    def train(self, z, log_ratio_update=False):
        ...
        expected_state_action_values = (self.algo_param.gamma * next_state_action_values).unsqueeze(
            1) + reward.unsqueeze(1) + self.algo_param.alpha * effective_log_ratio.unsqueeze(1)
