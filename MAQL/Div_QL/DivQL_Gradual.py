...
class DivQL_Gradual():
    ...
    def add_new_replay_buffer(self, current_z):
        ...
        for i in range(current_z+2):
            self.log_ratio_memory[i] = Replay_Memory(self.log_ratio_memory_capacity)
        ...
        self.current_index = current_z+1
    ...
    def sample_for_log_others(self, batch_size, current_z_index):
        ...
        mem_indices = [i and i != current_z_index for i in range(self.current_index+1)]
