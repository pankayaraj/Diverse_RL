...
M.load_main( "gradual_models/10x10/tabular_DivQL_KL/q", "gradual_models/10x10/tabular_DivQL_KL/target_q" )
...
ax.set_title("DivQL, KL, Tabular", fontsize = 30)
# Show the plot
plt.savefig("gradual_models/10x10/tabular_DivQL_KL")
