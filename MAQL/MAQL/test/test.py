...
M = MAQL(env, q_param, nu_param, algo_param)
...
for i in range(no_iteration):
    ...
    if i%update_interval == 0:
        ...
        if i != 0:
            ...
            #    if j%1000== 0:
            print("log_update ", str(j) + " learning_rate = " + str(M.log_ratio.current_lr) + " " + str(M.log_ratio.current_KL) )
                #M.train_log_ratio()
    ...
    if i%eval_interval == 0:
        ...
        print("reward of behaviour at itr " + str(i) + " = " + str(rew_beh) + " at state: " + str(s_t) + " starting from: " + str(
            i_s_t) + " at iter " + str(i))
        print("log_update " + " learning_rate = " + str(M.log_ratio.current_lr) + " current_log_ratio " + str(M.log_ratio.current_KL))
        ...
        for l in range(max_episode):
            ...
            if d_t == True:
                ...
                t_ = 0
        print("reward at itr " + str(i) + " = " + str(rew) + " at state: " + str(s_t) + " starting from: " + str(i_s_t) + " at iter " + str(i))
        print("reward_total = " + str(rew_tot) + " log totoal = " + str(log_tot_t) + " log_ratio_est = " + str(M.L))